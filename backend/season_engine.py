...
v2.2 修正(2026-07-19, 基于MAY深度分析报告):
- 波动率维度校准: 针对A股ATR%实际分布(0.008~0.025)重设阈值
- 市场宽度维度修复: 删除重复cur.fetchone()导致结果被覆盖为NULL
- 熊市侧评分修正: 增加roc20方向性扣分(roc20< -6%扣-2.5)
- 季节映射阈值放宽: spring从6.0降至4.5, summer从3.0降至2.0
- 熊市侧不再加严秋/冬边界(regime=bear与range一致)
- 趋势季节占比从8.4%升至24.2%
