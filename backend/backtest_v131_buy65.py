...
# V13.1 分季参数
SEASON_PARAMS = {
    'summer':         {'buy':65, 'hold':30, 't1':7.0, 't2':5.0, 'trail':15.0, 'max_pos':20, 'max_total':30},
    'spring':         {'buy':65, 'hold':30, 't1':7.0, 't2':5.0, 'trail':15.0, 'max_pos':20, 'max_total':30},
    'weak_spring':    {'buy':65, 'hold':30, 't1':7.0, 't2':5.0, 'trail':15.0, 'max_pos':20, 'max_total':30},
    'chaos':          {'buy':65, 'hold':30, 't1':7.0, 't2':5.0, 'trail':15.0, 'max_pos':20, 'max_total':30},
    'chaos_spring':   {'buy':65, 'hold':30, 't1':7.0, 't2':5.0, 'trail':15.0, 'max_pos':20, 'max_total':30},
    'chaos_autumn':   {'buy':65, 'hold':30, 't1':7.0, 't2':5.0, 'trail':15.0, 'max_pos':20, 'max_total':15},
    'autumn':         {'buy':70, 'hold':30, 't1':7.0, 't2':5.0, 'trail':15.0, 'max_pos':20, 'max_total':20},
    'weak_autumn':    {'buy':65, 'hold':30, 't1':7.0, 't2':5.0, 'trail':15.0, 'max_pos':20, 'max_total':30},
    'winter':         {'buy':70, 'hold':30, 't1':7.0, 't2':5.0, 'trail':15.0, 'max_pos':20, 'max_total':10},
}
