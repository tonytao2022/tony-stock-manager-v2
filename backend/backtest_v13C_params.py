...
# V13.1 分季参数
SEASON_PARAMS = {
    'summer':         {'buy':65, 'hold':60, 't1':12.0, 't2':9.0, 'trail':18.0, 'max_pos':50, 'max_total':50},
    'spring':         {'buy':65, 'hold':20, 't1':8.0, 't2':6.0, 'trail':12.0, 'max_pos':15, 'max_total':35},
    'weak_spring':    {'buy':72, 'hold':20, 't1':8.0, 't2':6.0, 'trail':12.0, 'max_pos':15, 'max_total':35},
    'chaos':          {'buy':48, 'hold':25, 't1':10.0, 't2':8.0, 'trail':12.0, 'max_pos':15, 'max_total':20},
    'chaos_spring':   {'buy':72, 'hold':20, 't1':8.0, 't2':6.0, 'trail':12.0, 'max_pos':15, 'max_total':35},
    'chaos_autumn':   {'buy':80, 'hold':15, 't1':5.0, 't2':4.0, 'trail':12.0, 'max_pos':5, 'max_total':15},
    'autumn':         {'buy':80, 'hold':15, 't1':5.0, 't2':4.0, 'trail':12.0, 'max_pos':8, 'max_total':15},
    'weak_autumn':    {'buy':80, 'hold':15, 't1':5.0, 't2':4.0, 'trail':12.0, 'max_pos':5, 'max_total':15},
    'winter':         {'buy':80, 'hold':10, 't1':5.0, 't2':4.0, 'trail':8.0, 'max_pos':5, 'max_total':10},
}
